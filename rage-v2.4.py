...
import Combiner
import callPeaks
#nohup python rage-v2.4.py $HOME/results/2014-04-07/rnaseqtrimmed.fastq $HOME/results/data/outputsfull/filter/ribotrimmedfiltered_rRNA_tRNA.fastq $HOME/testdata/k12genome_newheader.fasta -c false -f false -s ecolik12 -d $HOME/results/data/outputfullwglimmer/ &
#python rage-v2.4.py $HOME/testdata/k12rnaseq-test-3K.fastq $HOME/testdata/k12riboseq-test-3K.fastq $HOME/testdata/k12genome_newheader.fasta -c false -f false
#nohup python rage-v2.4.py $HOME/results/data/outputfullwglimmer/bowtie/rnaseqtrimmed.sorted.bam $HOME/results/data/outputsfull/bowtie/ribotrimmedfiltered_rRNA_tRNA.sam $HOME/testdata/k12genome.fasta -c false -f false -b false -s ecolik12 -d $HOME/results/data/outputsfinal0/ &
